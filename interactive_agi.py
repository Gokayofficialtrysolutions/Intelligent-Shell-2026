...
DEFAULT_CONFIG = {
    ...
    "model": { # New section for model related configurations
        ...
        "adapters_path": "./merged_model_adapters" # Default path for PEFT adapters
    }
}
...
# The `call_training_script` function that called 'train_on_interaction.sh' is now deprecated and removed.
# The primary mechanism for training data collection is the JSONL logging handled by `log_interaction_to_jsonl`.
# This simplifies the project by removing a redundant logging path.
...
def process_single_input_turn(user_input_str: str,
    ...
    # --- End of User Command Block ---
        ...
        # The call_training_script is being deprecated in favor of the more robust JSONL logging
        # for adaptive_train.py. The JSONL log is saved at the end of this function.
